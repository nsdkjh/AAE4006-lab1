...
F = [1 2 3;    1 3 4;    1 4 5;    1 5 2;    2 3 6;    3 4 6;    4 5 6;     5 2 6;    15 6 16];

F_wing = [7 8 9 10; 11 12 13 14];
...
handle_w = patch('Vertices', V1, 'Faces', F_wing,'FaceVertexCData',wing_colors,'FaceColor','flat');
title('Spacecraft')
xlabel('East')
ylabel('North')
zlabel('-Down')
